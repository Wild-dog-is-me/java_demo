...
/* 基于数组简易实现的哈希表 */
class ArrayHashMap {
  private java.util.List<Entry> bucket;
  public ArrayHashMap() {
    // 初始化一个长度为 100 的桶（数组）
  ...
  /* 获取所有键值对 */
  public java.util.List<Entry> entrySet() {
    java.util.List<Entry> entrySet = new ArrayList<>();
  ...
  /* 获取所有键 */
  public java.util.List<Integer> keySet() {
    java.util.List<Integer> keySet = new ArrayList<>();
    for (Entry pair : bucket) {
      if (pair != null)
        keySet.add(pair.key);
    }
